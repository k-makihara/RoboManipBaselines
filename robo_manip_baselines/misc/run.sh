...
# python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/RealUR5eDemo_20250624_190911 --camera_names front hand --train_ratio 1.0 --chunk_size 48 --action_keys measured_joint_pos --state_keys measured_joint_pos

# python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/RealUR5eDemo_20250624_190911 --camera_names front hand --train_ratio 1.0 --chunk_size 64 --action_keys measured_joint_pos --state_keys measured_joint_pos
...
python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/MujocoHsrPaP_20250715_163442 --camera_names head hand --train_ratio 1.0 --chunk_size 32 --state_keys measured_joint_pos measured_mobile_omni_vel --action_keys command_joint_pos command_mobile_omni_vel

python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/MujocoHsrShelfPaP_20250715_170353 --camera_names head hand --train_ratio 1.0 --chunk_size 32 --state_keys measured_joint_pos measured_mobile_omni_vel --action_keys command_joint_pos command_mobile_omni_vel

python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/MujocoHsrShelfRealPaP_20250715_180450 --camera_names head hand --train_ratio 1.0 --chunk_size 32 --state_keys measured_joint_pos measured_mobile_omni_vel --action_keys command_joint_pos command_mobile_omni_vel

python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/MujocoHsrPaP_20250715_163442 --camera_names head hand --train_ratio 1.0 --chunk_size 64 --state_keys measured_joint_pos measured_mobile_omni_vel --action_keys command_joint_pos command_mobile_omni_vel

python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/MujocoHsrShelfPaP_20250715_170353 --camera_names head hand --train_ratio 1.0 --chunk_size 64 --state_keys measured_joint_pos measured_mobile_omni_vel --action_keys command_joint_pos command_mobile_omni_vel

python ./bin/Train.py Act --dataset_dir /groups/gaf51379/physical-grounding/datasets/MujocoHsrShelfRealPaP_20250715_180450 --camera_names head hand --train_ratio 1.0 --chunk_size 64 --state_keys measured_joint_pos measured_mobile_omni_vel --action_keys command_joint_pos command_mobile_omni_vel