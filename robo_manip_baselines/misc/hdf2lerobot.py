...
def load_raw_episode_data(
    ...
    with h5py.File(ep_path, "r") as ep:
        state_all = ep["/measured_joint_pos"][:]

        action_all = ep["/command_joint_pos"][:]
        ...
        if "/measured_joint_vel" in ep:
            velocity_all = ep["/measured_joint_vel"][:]
        ...
        imgs_per_cam = {}
        imgs_per_cam["front_rgb"] = ep["/front_rgb_image"][:]
        imgs_per_cam["hand_rgb"] = ep["/hand_rgb_image"][:]
