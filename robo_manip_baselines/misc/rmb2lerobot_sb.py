    ...
    for task_path in dataset_paths:
        ...
        for ep_idx in tqdm.tqdm(episodes):
            ...
            #    task = "Grasp SEVEN&i PREMIUM Langue de Chat White Chocolate"
                ...
                task = "Grasp SEVEN&i PREMIUM Cheese-in-Snack Mentai Cheese"
            else:
